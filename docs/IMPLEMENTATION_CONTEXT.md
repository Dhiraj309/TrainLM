...
- PR3 (`milestone/m5-m7-xla-compatibility`) is merge-ready after mainline
  integration and CI fixes; its required write-access approval must be renewed after
  the history rewrite.
...
capability-based optimization planning are next stories. Do not mark M8-F0
...
2. **M8-F2/F3 planner:** add version-guarded adapter registry and a pure,
