...
**Status:** [~] M1-F1-M1-F3 complete; M1-F4 implemented and awaiting validation
...
- [ ] CPU contracts prove trainer, task, optimization, and runtime interfaces
  have no family or XLA dependency.
