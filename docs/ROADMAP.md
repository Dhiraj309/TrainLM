...
| [~] | PR3 | `milestone/m5-m7-xla-compatibility` | M5-M7 | 9 | M5-F1-F7 and M6-F1-F2 implemented; target TPU validation pending |
...
9 implemented feature commits and 7 feature commits remaining before the
...
| [~] | M6 | F1-F2 positional and attention-layout coverage implemented; TPU matrix validation pending |
...
**Status:** [~] M6-F1-F2 implemented; target TPU validation pending
